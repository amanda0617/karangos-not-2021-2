...
import logoImg from '/workspace/karangos-not-2021-2/karangos/src/vintage-cars.png'
...
export default function HomePage() {
    ...
    function handleGoSurprise() {
        setVisible(true)
    }

    function handleNotSurprise() {
        setVisible(false)
    }
    ...
    return (
        <>
            ...
            <p><Button color="secondary" variant="contained" onClick={handleGoSurprise}>
                Surpresa!
                </Button></p>
            <img src={logoImg} alt="Carros antigos" style={{opacity: visible ? '1' : '0', height: visible ? '591px': '0'}} />
        </>
    )
